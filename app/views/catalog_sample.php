		...
		<div class="row">
			<div class="col-sm-2">
				...
				<ul class="list-group border" style="background-color: #e6e6e6;">
					<a href="catalog_sample.php" class="category category-all">
					...
					<?php
					 ...
					 foreach ($categories as $category) { ?>
					 	<a href="catalog_sample.php? category_id=<?php echo $category['id'];?>" class="category" data-id ="<?php echo $category['id']?>">
					 	<li class="list-group-item">
